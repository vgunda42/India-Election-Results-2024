...
count(cr.Parliament_Constituency) as Total_Seats_Available
...
--Add new column filed in table partywise results to get the party allianz as NDA, I.N.D.I.A
...
---Which party won the most seats across all states
...
---Winning candidate name, party name, total votes, and margin of victory for a specific state and constituency
...
--Distribution of EVM votes versus postal for candidates in a specific constituency
